...
const numbersPerSegment = 15,          // 1x Grün, 7x Schwarz & Rot
      placefillerSegmentsBefore = 4,   // 4x15 Nummern Platzfüller davor
      placefillerSegmentsAfter = 1   // 1x15 Nummern Platzfüller danach

// 0 = Grün; Gerade Zahlen = Rot; Ungerade Zahlen = Schwarz
export default function Wheel() {
  function NumberElement(props) {
    function getNumberCSSColor(number) {
      return number === 0
        ? 'var(--theme-color)'
        : number % 2 === 0
          ? 'red'
  ...
  function Numbers() {
    ...
    // Erste 4x15 Platzfüller für lange Spin Animation
    ...
    for (let i = 0; i < placefillerSegmentsAfter; i++) {
